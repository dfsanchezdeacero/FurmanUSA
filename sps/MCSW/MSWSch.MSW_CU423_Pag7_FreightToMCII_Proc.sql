ALTER PROCEDURE [MSWSch].[MSW_CU423_Pag7_FreightToMCII_Proc]	
	 @pnClaUsuarioMod	INT			= 1
	,@psNombrePcMod		VARCHAR(64) = 'JOB MSW - FURMAN'
	,@pnEsDebug			TINYINT		= 0
AS
BEGIN
--JOB MSW - FURMAN
...
--DELETE FROM [MSWSch].[MSWTraFurmanFreightToMCSWAnioMes]
--SELECT * FROM [MSWSch].[MSWTraFurmanFreightToMCSWAnioMes] ORDER BY ClaAnioMes
