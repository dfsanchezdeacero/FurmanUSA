CREATE TABLE [OpeSch].[OpeFreightFromHoustonToLocation](
	IdFreightHou INT
	,AnioMes		  INT
 ...
 CONSTRAINT [PK_OpeFreightFromHoustonToLocation] PRIMARY KEY CLUSTERED 
(
	[IdFreightHou] ASC
...
ALTER TABLE [OpeSch].[OpeFreightFromHoustonToLocation] ADD  DEFAULT (getdate()) FOR [FechaUltimaMod]
GO

ALTER TABLE [OpeSch].[OpeFreightFromHoustonToLocation] ADD  DEFAULT (host_name()) FOR [NombrePcMod]
GO